...
TEST(cINIGroup, Basic) {
    ...
    string sGroup = oGroup.ToString();
    string sShouldResult = "[Settings]\n"
                           "name=hello world!\n";
...
TEST(cINIContainer, Basic) {
    ...
    string sINISettings = oContainer.ToString();
    string sShouldResult = "[Settings1]\n"
                           "name=hello world1!\n"
                           "[Settings2]\n"
                           "name=hello world2!\n";
